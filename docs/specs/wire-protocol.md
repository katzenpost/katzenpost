...
>
> Finally the [ChaChaPoly_BLAKE2b]{.title-ref} parts of the protocol
...
> ([\[KYBER\]](#KYBER){.citation} and
> [\[RFC7748\]](#RFC7748){.citation}), the public component of which is
> known to the other party in advance. How such keys are distributed is
...
> ([h]{.title-ref}) for the purpose of implementing authentication
> (Section 2.3).
>
