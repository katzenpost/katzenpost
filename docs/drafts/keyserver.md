...
effective against user enumeration XXXTODO: CROSS-REF to some other
proper spec \]
...
-   Key rotation implies key refreshes. How is this to be made in a way
    that doesn\'t leak info?
