...
Read Introduction blog post: \"Introduction to Mix Networks and
...
\"Impact of Network Topology on Anonymity and Overhead in Low-Latency
Anonymity Networks\"
...
Watch lecture \"Introduction to Statistical Disclosure Attacks and
Defenses for Mix Networks\"
...
network protocols can be found here:

-   <http://millitsa.coe.neu.edu/?q=publications>

\"Optimization of a Data Link Protocol for an Underwater Acoustic
Channel\"
...
\"Controlling Queue Delay: A modern AQM is just one piece of the
...
NOTE: for more reading on this subject refer to Dr. Sally Floyd\'s ECN
reading list:
...
\"Performance Evaluation of Explicit Congestion Notification (ECN) in IP
Networks\"
