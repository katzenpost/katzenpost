...
func (c *Client) ComposeSphinxPacket(recipient []byte, provider *[32]byte, surbID *[sConstants.SURBIDLength]byte, b []byte) ([]byte, []byte, time.Duration, error) {
...
func (c *Client) SendUnreliableCiphertext(recipient []byte, provider *[32]byte, b []byte) error {
