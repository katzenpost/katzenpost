...
func (c *Client) ComposeSphinxPacket(recipient []byte, provider string, surbID *[sConstants.SURBIDLength]byte, b []byte) ([]byte, []byte, time.Duration, error) {
...
func (c *Client) SendUnreliableCiphertext(recipient []byte, provider string, b []byte) error {
...
// round trip delay.
func (c *Client) SendCiphertext(recipient []byte, provider string, surbID *[sConstants.SURBIDLength]byte, b []byte) ([]byte, time.Duration, error) {
...
func (c *Client) makePath(recipient []byte, provider string, surbID *[sConstants.SURBIDLength]byte, baseTime time.Time, isForward bool) ([]*path.PathHop, time.Time, error) {
