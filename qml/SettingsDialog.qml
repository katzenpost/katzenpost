    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            ...
            ComboBox {
                ...
                Layout.fillWidth: true
                model: ["Full", "Anonymized", "Disabled"]
                Component.onCompleted: {
                    notificationIndex = find(settings.notification, Qt.MatchFixedString)
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    settings.notification = notificationBox.displayText
            ...
            Button {
                ...
                onClicked: {
                    ...
                    notificationBox.currentIndex = notificationBox.notificationIndex
                    settingsDialog.close()
                }
            }
        }
