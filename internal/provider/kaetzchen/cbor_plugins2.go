...
// CBORPluginWorker2 is similar to Kaetzchen worker but uses
// CBOR over HTTP over UNIX domain socket to talk to plugins.
type CBORPluginWorker2 struct {
	sync.Mutex
	worker.Worker
...
func (k *CBORPluginWorker2) OnKaetzchen(pkt *packet.Packet) {
...
func (k *CBORPluginWorker2) haltAllClients() {
...
func (k *CBORPluginWorker2) KaetzchenForPKI() ServiceMap {
	s := make(ServiceMap)
...
func (k *CBORPluginWorker2) IsKaetzchen(recipient [sConstants.RecipientIDLength]byte) bool {
...
// NewCBORPluginWorker2 returns a new CBORPluginWorker2
func NewCBORPluginWorker2(glue glue.Glue) (*CBORPluginWorker2, error) {

	kaetzchenWorker := CBORPluginWorker2{
		glue:        glue,
