			...
			Gateways: []*config.Gateway{
				{
					...
					LinkKey:            config.LinkPublicKey{PublicKey: gwlinkPubKey},
			...
			Peers: []*vServerConfig.Authority{
				{
					...
					PKISignatureScheme: pkiSchemeName,
					LinkPublicKey:      vServerConfig.LinkPublicKey{PublicKey: authlinkPubKey},
					WireKEMScheme:      WireKEMSchemeName,
...
func setupTestGatewayFull(t *testing.T, gwAddr string, env *testGatewayEnv, handler func(t *testing.T, wireConn *wire.Session, cmds *commands.Commands, cmd commands.Command) bool) *config.Config {
	...
	clientCfg := &config.Config{
		...
		VotingAuthority: &config.VotingAuthority{
			Peers: []*vServerConfig.Authority{
				{Identifier: "auth1", IdentityPublicKey: env.authKeys[0].pub, PKISignatureScheme: "ed25519", LinkPublicKey: vServerConfig.LinkPublicKey{PublicKey: authlinkPubKey}, WireKEMScheme: "x25519", Addresses: []string{"tcp://127.0.0.1:1301"}},
				{Identifier: "auth2", IdentityPublicKey: env.authKeys[1].pub, PKISignatureScheme: "ed25519", LinkPublicKey: vServerConfig.LinkPublicKey{PublicKey: authlinkPubKey}, WireKEMScheme: "x25519", Addresses: []string{"tcp://127.0.0.1:1302"}},
				{Identifier: "auth3", IdentityPublicKey: env.authKeys[2].pub, PKISignatureScheme: "ed25519", LinkPublicKey: vServerConfig.LinkPublicKey{PublicKey: authlinkPubKey}, WireKEMScheme: "x25519", Addresses: []string{"tcp://127.0.0.1:1303"}},
			},
		},
	}
